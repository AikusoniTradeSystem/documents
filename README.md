...
## 프로젝트 개요
AikusoniTradeSystem은 게임 아이템 경매와 인벤토리 관리를 돕기 위해 설계된 간단한 플랫폼입니다. \
...
#### 아이템 거래 통계 API 서버
- 레포: item-transaction-statistics-api
- 기술: Spring Boot (Spring MVC)
